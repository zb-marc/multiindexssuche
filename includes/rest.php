<?php
/**
 * REST API-Endpunkte für das AS Multiindex Search Plugin.
 *
...
// Include-Guard NUR für Funktionen, NICHT für Hooks!
if ( ! function_exists( 'asmi_register_rest_routes' ) ) {
	...
	function asmi_register_rest_routes() {
		...
		// WordPress-Indexierung - WICHTIG: /wp-index/start statt /wp-index/reindex
...
} // Ende Include-Guard für Funktionen

// WICHTIG: add_action AUSSERHALB des Include-Guards!
